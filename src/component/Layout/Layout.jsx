...
export const Layout = ({ children }) => (
  <div className="flex flex-col min-h-full bg-gray-200">
    <div className="bg-[#b916f9] flex justify-center">
...
export const LayoutWithoutNavBar = ({ children }) => (
  <div className="flex flex-col h-full">
    <div className="flex h-14">
      <div className="bg-[#b916f9] grow flex justify-center items-center text-lg text-white">Twilio SMS Web</div>
    </div>
